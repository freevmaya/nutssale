...
<head>
  ...
  <link rel="stylesheet" href="css-mob/style.css?v=1">
...
<body ng-app="app" ng-controller="appController">
  <header>
    <div class="container flex-box">
      <div>
        <a class="logo" href=""><img src="images/logo.png" alt="<?=$key1?>"><span><?=$key1?></span></a>
      </div>
      <div>
        <a class="btn-border btn" data-fancybox data-src="#zapros-kp" href="javascript:;"><span>Запросить КП</span></a>
      </div>
      <div class="contact">
        <a class="phone" href="tel:+78005113623">+7 (800) 511-36-23</a>
  ...
  <div id="homescreen">
    <div class="container flex-box">
      <div class="text">
        ...
        <table>
          <tr>
            <td class="pic"><img class="n1" src="images/01-pic.png" alt="<?=$key4?>">
              <img class="n2 spin-it" src="images/01-pic-1.png" alt="<?=$key1?>"><img class="n3 spin-it" src="images/01-pic-2.png" alt="<?=$key2?>"><img class="n4 spin-it" src="images/01-pic-3.png" alt="<?=$key3?>"><img class="n5 spin-it" src="images/01-pic-4.png" alt="<?=$key4?>"></td>
            <td>
        ...
        <div class="btn-box">
          <a class="btn btn-green" data-fancybox data-src="#order" href="javascript:;"><span>Заказать</span></a>
        </div>
      </div>
    </div>
  </div>
  ...
  <div id="flavours">
    <div class="container">
      ...
      <div class="form">
        <h2>Хотите самостоятельно рассчитать стоимость заказа?<br>Скачайте подробный прайс-лист с перечнем скидок</h2>
        <div class="btn-box">
          <a class="btn-green btn" data-fancybox data-src="#download" href="javascript:;"><span>Скачать прайс-лист</span></a>
        </div>
      </div>
    </div>
  </div>
  ...
  <div id="quality">
    <div class="container">
      ...
      <div class="inn">
        <div class="txt">
          <table>
            <tr><td>Тщательный отбор поставщиков сырья</td></tr>
            <tr><td>Лабораторный контроль продукции при поступлении на скла</td></tr>
            <tr><td>Многоэтапный лабораторный контроль готовой продукции</td></tr>
            <tr><td>Образцы продукции из каждой партии хранятся в течение года, чтобы при необходимости убедиться в их качестве</td></tr>
          </table>
        </div>
      </div>
    </div>
  ...
  <div id="special-conditions">
    <div class="bg"></div>
    <div class="container">
      <h2>Постоянным партнерам мы предлагаем обсобые условия сотрудничества</h2>
      <div class="bx n1">
        <p>Специальные условия при оплате<br>наличными</p>
      </div>
      <div class="bx n2">
        <p>Частичная компенсация стоимости доставки</p>
      </div>
      <div class="bx n3">
        <p>Разнообразные маркетинговые акции</p>
      </div>
    </div>
    <div class="form">
      <div class="container">
  ...
  <div id="checkout">
    <div class="container">
      ...
      <h2 class="n2" style="margin-top: 15px;">Нет? Тогда предлагаем Вам особые условия сотрудничества:</h2><img class="pic1" src="images/12-pic.png" alt="<?=$key1?>">
      <div class="txt">
  ...
  <footer>
    <div class="container">
      ...
      <div class="footer clear">
        <div class="contact"><a class="phone" href="tel:+78007771528">+7 (800) 777-15-28</a><a class="mail" href="mailto:zakaz-arahis@yandex.ru">zakaz-arahis@yandex.ru</a></div>
        <table>
          <tr>
            <td align="left"><p>Общество с ограниченной ответственностью «Уральский лидер»<br>454047, г. Челябинск, ул. 2-ая Павелецкая, д.36, корп.13, пом. 68<br>ОГРН 1157460002457 ИНН 7460021387 КПП 746001001<br>р/сч 40702810490530002947 ОАО «ЧЕЛЯБИНВЕСТБАНК»</p></td>
            <td><a class="logo" href=""><img src="images/logo-1.png" alt="Арахис глазированный"><span>Арахис глазированный</span></a></td>
          </tr>
        </table>
        <div><a class="link" data-fancybox data-src="#privacy-policy" href="javascript:;">Политика конфиденциальности</a></div>
      </div>
    </div>
  </footer>
  ...
  <div class="user-agent">
    <?=$isdev?$mobile_detect->getUserAgent():''?>
  </div>
</body>
